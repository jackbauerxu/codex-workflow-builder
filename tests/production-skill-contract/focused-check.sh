...
require_file scripts/stock-analysis.md
...
require_file prompts/stock-analysis.md
...
require_file examples/stock-analysis.md
...
printf '39/39 production-skill contract checks passed\n'
